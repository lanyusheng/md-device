...
interface BusinessToolbarProps<TData> {
  table: Table<TData>;
}

export function BusinessToolbar<TData>({ table }: BusinessToolbarProps<TData>) {
  const { fetchBusinesses, isLoading } = useCompanyStore();
  const isFiltered =
